...
return [
    'modules' => [
        ...
        'Cognixia_Blogs' => 1,
        'Cognixia_ChangeBreadcumbs' => 0,
        'Cognixia_CustomCustomerAttrib' => 1,
        'Cognixia_CustomDBModule' => 0,
        'Cognixia_CustomerDisableRegistration' => 1,
        'Cognixia_DataRepository' => 0,
        'Cognixia_DisplayContactUsMsg' => 0,
        'PayPal_Braintree' => 1,
